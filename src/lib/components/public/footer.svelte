		...
		>
			<div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
				<a href="/" class="flex justify-center lg:justify-start">
					<img src={logo} alt="Codegio" class="h-8 w-auto dark:hidden" />
					<img src={logoWhite} alt="Codegio" class="hidden h-8 w-auto dark:block" />
				</a>
				<p
			...
			<div class="lg:mx-auto text-left">
				<h4 class="text-lg text-foreground font-medium mb-7">Codegio</h4>
			...
			<div class="lg:mx-auto text-left">
				<h4 class="text-lg text-foreground font-medium mb-7">Products</h4>
				<ul class="text-sm transition-all duration-500">
					<li class="mb-6">
						<a href="/products/figma" class="text-muted-foreground hover:text-foreground transition-colors">Figma UI System</a>
					</li>
					<li class="mb-6">
						<a href="/products/icons" class="text-muted-foreground hover:text-foreground transition-colors">Icons Assets</a>
					</li>
					<li>
						<a href="/products/blocks" class="text-muted-foreground hover:text-foreground transition-colors">Responsive Blocks</a>
					</li>
				</ul>
			</div>

			<div class="lg:mx-auto text-left">
				<h4 class="text-lg text-foreground font-medium mb-7">Support</h4>
				<ul class="text-sm transition-all duration-500">
					<li class="mb-6">
						<a href="/support" class="text-muted-foreground hover:text-foreground transition-colors">Customer Support</a>
					</li>
					<li class="mb-6">
						<a href="/terms" class="text-muted-foreground hover:text-foreground transition-colors">Terms & Conditions</a>
					</li>
					<li>
						<a href="/privacy" class="text-muted-foreground hover:text-foreground transition-colors">Privacy Policy</a>
					</li>
				</ul>
			</div>

			<div class="lg:mx-auto text-left">
				<h4 class="text-lg text-foreground font-medium mb-7">Subscribe</h4>
			...
			<div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row gap-4">
				...
				<div class="flex gap-4 sm:justify-center lg:mt-0">
					<a
						...
						class="size-8 rounded-full flex justify-center items-center bg-[#33CCFF] hover:bg-primary text-white transition-colors"
						aria-label="Twitter"
					>
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						class="size-8 rounded-full flex justify-center items-center bg-[linear-gradient(45deg,#FEE411_6.9%,#FEDB16_10.98%,#FEC125_17.77%,#FE983D_26.42%,#FE5F5E_36.5%,#FE2181_46.24%,#9000DC_85.57%)] hover:bg-primary text-white transition-colors"
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						class="size-8 rounded-full flex justify-center items-center bg-[#337FFF] hover:bg-primary text-white transition-colors"
						aria-label="Facebook"
					>
						<svg class="size-4" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						class="size-8 rounded-full flex justify-center items-center bg-[#FF0000] hover:bg-primary text-white transition-colors"
						aria-label="YouTube"
					>
						<svg class="size-5" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								fill-rule="evenodd"
								clip-rule="evenodd"
